...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG4), 0x00800000u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC2), 0x00000034u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000004u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00DB67B0u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_INTR_CFG), 0x00000040u);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x0000003Du);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC2), 0x0000000Fu);
