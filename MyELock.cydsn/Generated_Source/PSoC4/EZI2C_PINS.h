...
/* Unconfigured pins */
#define EZI2C_REMOVE_RX_WAKE_SDA_MOSI_PIN  (1u)
#define EZI2C_REMOVE_RX_SDA_MOSI_PIN      (1u)
#define EZI2C_REMOVE_TX_SCL_MISO_PIN      (1u)
...
/* Unconfigured pins */
#define EZI2C_RX_WAKE_SDA_MOSI_PIN (0u == EZI2C_REMOVE_RX_WAKE_SDA_MOSI_PIN)
#define EZI2C_RX_SDA_MOSI_PIN     (0u == EZI2C_REMOVE_RX_SDA_MOSI_PIN)
#define EZI2C_TX_SCL_MISO_PIN     (0u == EZI2C_REMOVE_TX_SCL_MISO_PIN)
...
#if (EZI2C_RX_WAKE_SDA_MOSI_PIN)
    #include "EZI2C_uart_rx_wake_i2c_sda_spi_mosi.h"
#endif /* (EZI2C_RX_SDA_MOSI) */

#if (EZI2C_RX_SDA_MOSI_PIN)
    #include "EZI2C_uart_rx_i2c_sda_spi_mosi.h"
#endif /* (EZI2C_RX_SDA_MOSI) */

#if (EZI2C_TX_SCL_MISO_PIN)
    #include "EZI2C_uart_tx_i2c_scl_spi_miso.h"
#endif /* (EZI2C_TX_SCL_MISO) */
...
#if (EZI2C_RX_SDA_MOSI_PIN)
    #define EZI2C_RX_SDA_MOSI_HSIOM_REG   (*(reg32 *) EZI2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    #define EZI2C_RX_SDA_MOSI_HSIOM_PTR   ( (reg32 *) EZI2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    
    #define EZI2C_RX_SDA_MOSI_HSIOM_MASK      (EZI2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define EZI2C_RX_SDA_MOSI_HSIOM_POS       (EZI2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define EZI2C_RX_SDA_MOSI_HSIOM_SEL_GPIO  (EZI2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define EZI2C_RX_SDA_MOSI_HSIOM_SEL_I2C   (EZI2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define EZI2C_RX_SDA_MOSI_HSIOM_SEL_SPI   (EZI2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define EZI2C_RX_SDA_MOSI_HSIOM_SEL_UART  (EZI2C_uart_rx_i2c_sda_spi_mosi__0__HSIOM_UART)
    
#elif (EZI2C_RX_WAKE_SDA_MOSI_PIN)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG   (*(reg32 *) EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_PTR   ( (reg32 *) EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_MASK      (EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_POS       (EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_GPIO  (EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C   (EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI   (EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART  (EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_UART)    
   
    #define EZI2C_RX_WAKE_SDA_MOSI_INTCFG_REG (*(reg32 *) EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define EZI2C_RX_WAKE_SDA_MOSI_INTCFG_PTR ( (reg32 *) EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define EZI2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (EZI2C_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define EZI2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK ((uint32) EZI2C_INTCFG_TYPE_MASK << \
                                                                           EZI2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins EZI2C_RX_SDA_MOSI_PIN or EZI2C_RX_WAKE_SDA_MOSI_PIN present.*/
#endif /* (EZI2C_RX_SDA_MOSI_PIN) */

#if (EZI2C_TX_SCL_MISO_PIN)
    #define EZI2C_TX_SCL_MISO_HSIOM_REG   (*(reg32 *) EZI2C_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    #define EZI2C_TX_SCL_MISO_HSIOM_PTR   ( (reg32 *) EZI2C_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    
    #define EZI2C_TX_SCL_MISO_HSIOM_MASK      (EZI2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_MASK)
    #define EZI2C_TX_SCL_MISO_HSIOM_POS       (EZI2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_SHIFT)
    #define EZI2C_TX_SCL_MISO_HSIOM_SEL_GPIO  (EZI2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_GPIO)
    #define EZI2C_TX_SCL_MISO_HSIOM_SEL_I2C   (EZI2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_I2C)
    #define EZI2C_TX_SCL_MISO_HSIOM_SEL_SPI   (EZI2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_SPI)
    #define EZI2C_TX_SCL_MISO_HSIOM_SEL_UART  (EZI2C_uart_tx_i2c_scl_spi_miso__0__HSIOM_UART)
#endif /* (EZI2C_TX_SCL_MISO_PIN) */
...
/* Pins settings index. */
#define EZI2C_RX_WAKE_SDA_MOSI_PIN_INDEX   (0u)
#define EZI2C_RX_SDA_MOSI_PIN_INDEX       (0u)
#define EZI2C_TX_SCL_MISO_PIN_INDEX       (1u)
...
/* Pins settings mask. */
#define EZI2C_RX_WAKE_SDA_MOSI_PIN_MASK ((uint32) 0x01u << EZI2C_RX_WAKE_SDA_MOSI_PIN_INDEX)
#define EZI2C_RX_SDA_MOSI_PIN_MASK     ((uint32) 0x01u << EZI2C_RX_SDA_MOSI_PIN_INDEX)
#define EZI2C_TX_SCL_MISO_PIN_MASK     ((uint32) 0x01u << EZI2C_TX_SCL_MISO_PIN_INDEX)
...
#if (EZI2C_TX_SCL_MISO_PIN)
    #define EZI2C_CHECK_TX_SCL_MISO_PIN_USED \
                (EZI2C_PIN_DM_ALG_HIZ != \
                    EZI2C_GET_P4_PIN_DM(EZI2C_uart_tx_i2c_scl_spi_miso_PC, \
                                                   EZI2C_uart_tx_i2c_scl_spi_miso_SHIFT))
#endif /* (EZI2C_TX_SCL_MISO_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define EZI2C_SET_I2C_SCL_DR(val) \
                            EZI2C_uart_rx_wake_i2c_sda_spi_mosi_Write(val)

    #define EZI2C_SET_I2C_SCL_HSIOM_SEL(sel) \
                    EZI2C_SET_HSIOM_SEL(EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG,  \
                                                   EZI2C_RX_WAKE_SDA_MOSI_HSIOM_MASK, \
                                                   EZI2C_RX_WAKE_SDA_MOSI_HSIOM_POS,  \
                                                   (sel))

    #define EZI2C_WAIT_SCL_SET_HIGH  (0u == EZI2C_uart_rx_wake_i2c_sda_spi_mosi_Read())

#elif (EZI2C_RX_SDA_MOSI_PIN)
    #define EZI2C_SET_I2C_SCL_DR(val) \
                            EZI2C_uart_rx_i2c_sda_spi_mosi_Write(val)


    #define EZI2C_SET_I2C_SCL_HSIOM_SEL(sel) \
                            EZI2C_SET_HSIOM_SEL(EZI2C_RX_SDA_MOSI_HSIOM_REG,  \
                                                           EZI2C_RX_SDA_MOSI_HSIOM_MASK, \
                                                           EZI2C_RX_SDA_MOSI_HSIOM_POS,  \
                                                           (sel))

    #define EZI2C_WAIT_SCL_SET_HIGH  (0u == EZI2C_uart_rx_i2c_sda_spi_mosi_Read())
...
#elif (EZI2C_TX_SCL_MISO_PIN)
    #define EZI2C_WAIT_SDA_SET_HIGH  (0u == EZI2C_uart_tx_i2c_scl_spi_miso_Read())
#else
...
/* Clear UART wakeup source */
    ...
    #define EZI2C_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) EZI2C_uart_rx_wake_i2c_sda_spi_mosi_ClearInterrupt(); \
            }while(0)
...
/* Unconfigured pins */
#define EZI2C_REMOVE_MOSI_SCL_RX_WAKE_PIN    EZI2C_REMOVE_RX_WAKE_SDA_MOSI_PIN
#define EZI2C_REMOVE_MOSI_SCL_RX_PIN         EZI2C_REMOVE_RX_SDA_MOSI_PIN
#define EZI2C_REMOVE_MISO_SDA_TX_PIN         EZI2C_REMOVE_TX_SCL_MISO_PIN
...
/* Unconfigured pins */
#define EZI2C_MOSI_SCL_RX_WAKE_PIN   EZI2C_RX_WAKE_SDA_MOSI_PIN
#define EZI2C_MOSI_SCL_RX_PIN        EZI2C_RX_SDA_MOSI_PIN
#define EZI2C_MISO_SDA_TX_PIN        EZI2C_TX_SCL_MISO_PIN
...
#define EZI2C_SS0_PIN                EZI2C_RTS_SS0_PIN
    ...
    #define EZI2C_MOSI_SCL_RX_WAKE_HSIOM_REG     EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define EZI2C_MOSI_SCL_RX_WAKE_HSIOM_PTR     EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define EZI2C_MOSI_SCL_RX_WAKE_HSIOM_MASK    EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define EZI2C_MOSI_SCL_RX_WAKE_HSIOM_POS     EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define EZI2C_MOSI_SCL_RX_WAKE_INTCFG_REG    EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define EZI2C_MOSI_SCL_RX_WAKE_INTCFG_PTR    EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define EZI2C_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define EZI2C_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG
#endif /* (EZI2C_RX_WAKE_SDA_MOSI_PIN) */

#if (EZI2C_MOSI_SCL_RX_PIN)
    #define EZI2C_MOSI_SCL_RX_HSIOM_REG      EZI2C_RX_SDA_MOSI_HSIOM_REG
    #define EZI2C_MOSI_SCL_RX_HSIOM_PTR      EZI2C_RX_SDA_MOSI_HSIOM_PTR
    #define EZI2C_MOSI_SCL_RX_HSIOM_MASK     EZI2C_RX_SDA_MOSI_HSIOM_MASK
    #define EZI2C_MOSI_SCL_RX_HSIOM_POS      EZI2C_RX_SDA_MOSI_HSIOM_POS
#endif /* (EZI2C_MOSI_SCL_RX_PIN) */

#if (EZI2C_MISO_SDA_TX_PIN)
    #define EZI2C_MISO_SDA_TX_HSIOM_REG      EZI2C_TX_SCL_MISO_HSIOM_REG
    #define EZI2C_MISO_SDA_TX_HSIOM_PTR      EZI2C_TX_SCL_MISO_HSIOM_REG
    #define EZI2C_MISO_SDA_TX_HSIOM_MASK     EZI2C_TX_SCL_MISO_HSIOM_REG
    #define EZI2C_MISO_SDA_TX_HSIOM_POS      EZI2C_TX_SCL_MISO_HSIOM_REG
...
#define EZI2C_MOSI_SCL_RX_WAKE_PIN_INDEX EZI2C_RX_WAKE_SDA_MOSI_PIN_INDEX
#define EZI2C_MOSI_SCL_RX_PIN_INDEX      EZI2C_RX_SDA_MOSI_PIN_INDEX
#define EZI2C_MISO_SDA_TX_PIN_INDEX      EZI2C_TX_SCL_MISO_PIN_INDEX
...
#define EZI2C_MOSI_SCL_RX_WAKE_PIN_MASK EZI2C_RX_WAKE_SDA_MOSI_PIN_MASK
#define EZI2C_MOSI_SCL_RX_PIN_MASK      EZI2C_RX_SDA_MOSI_PIN_MASK
#define EZI2C_MISO_SDA_TX_PIN_MASK      EZI2C_TX_SCL_MISO_PIN_MASK
